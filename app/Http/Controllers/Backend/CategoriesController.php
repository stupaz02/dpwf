...
class CategoriesController extends BackendController
{
    ...
    public function store(CategoryStoreRequest $request)
    {
        ...
        return redirect()->route("categories.index")->with('message','New category was created successfully!');
    }
    ...
    public function update(CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect()->route('categories.index')->with('message','Category was updated successfullly!');
    }
    ...
    public function destroy(CategoryDestroyRequest $request, $id)
    {
        ...
        $category = Category::findOrFail($id);
        $category->delete();
        return redirect()->route('categories.index')->with('message','Category was deleted successfullly!');
    }
}
